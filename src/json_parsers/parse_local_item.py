...
city="bangalore"
folder_path = f"swiggy/data/menus/intermidiate/{city}/Local_restaurant/"
...
for json_file in json_files:
    ...
    with open(file_path, 'r') as file:
        ...
        try:
                ...
                if chase:
                    ...
                    for itemcards in chaser:
                        ...
                        for card in item:
                            ...
                            Price=info.get("defaultPrice","N/A")
                            defaultPrice=str(Price)[:-2]
                            description=info.get("description","N/A")
                            id=info['id']
                            ribbon = info["ribbon"].get("text", "Common")
                            vegClassifier = info["itemAttribute"].get("vegClassifier", "Not Available")
                            rating = info["ratings"]["aggregatedRating"].get("rating", "N/A")
                            ...
                            if variants:
                                for variant_group in variants:
                                    ...
                                    for variation in variations:
                                        ...
                                        result_info.append([choice_name,choice_price])
                            Final_list.append([id,category,ribbon,vegClassifier,name,rating,defaultPrice,description,result_info,img_url])
            ...
            output_filename="swiggy/data/menus/output/{}/Local_restaurant/{}.csv".format(city,json_file)
            output_dir = os.path.dirname(output_filename)
            os.makedirs(output_dir, exist_ok=True)
            menu_df.to_csv(output_filename)
